(function($) {
	...
	$(document).ready(function() {
		...
		$('#content .bxslider').bxSlider({
			slideWidth: total_width * 0.34,
			infiniteLoop: true,
			pager: false,
			responsive: true
		});
		$('#home-nav .bxslider').bxSlider({
			slideWidth: total_width * 0.66,
			infiniteLoop: true,
			pager: false,
			responsive: true
		});
	...
	$(document).ready(function() {
		...
		// 			var stageImage = $('<div class="image-caption">' + caption + '</div><a href="' + full_url + '" rel="shadowbox"><img src="' + $(this).attr('href') + '" /></a>');
