...
class ArteForaDoMuseu_ArtGuides {
	...
	function user_menu_items() {
		if(afdm_get_user_artguides()) : ?>
			<li><a href="<?php echo $this->get_user_link(); ?>"><?php _e('My collections', 'arteforadomuseu'); ?></a></li>
		<?php endif; ?>
		<li><a href="#" class="add_guide"><?php _e('Create collection', 'arteforadomuseu'); ?></a></li>
		<?php
	}
...
function afdm_artguides_remove_artwork_button($guide_id, $artwork_id = false) {
	global $artguides;
	return $artguides->hook_remove_artwork_button($guide_id, $artwork_id);
}
