...
class ArteForaDoMuseu_Artworks {
	...
	function user_menu_items() {
		?>
		<li><a href="#" class="add_artwork"><?php _e('Submit a suggestion to the map', 'arteforadomuseu'); ?></a></li>
		<?php
	}
	...
	function add_artwork_box() {
		if(current_user_can('edit_posts')) { 
			?>
			<div id="add_artwork">
				<h2 class="lightbox_title"><span class="lsf">&#xE041;</span> <?php _e('Submit a suggestion', 'arteforadomuseu'); ?></h2>
			...
			<div id="add_artwork">
				<h2 class="lightbox_title"><span class="lsf">&#xE041;</span> <?php _e('Submit a suggestion', 'arteforadomuseu'); ?></h2>
				<div class="lightbox_content">
					<p><?php _e('Para enviar uma sugestão, é necessário estar logado. Faça o login abaixo:'); ?></p>
	...
	function ajax_add_artwork() {
		...
		$this->ajax_response(array('success_msg' => __('Congratulations! Your suggestion is now pending approval, soon you\'ll see it here.', 'arteforadomuseu')));
